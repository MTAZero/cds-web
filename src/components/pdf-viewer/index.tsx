...
type Props = {base64: any | null; style?: any | null};
const PdfViewer = (props: Props) => {
  const {base64, style = {height: "750px"}} = props;
  ...
  useEffect(() => {
    ...
    if (!base64) {
      ...
      setUrl(URL.createObjectURL(base64toBlob(base64)));
    }
  }, [base64]);
  ...
  return (
    <Worker workerUrl="/workerPdf.min.js">
      <div style={style} className="pdf-viewer">
        {url && (
          <Viewer
            fileUrl={url}
