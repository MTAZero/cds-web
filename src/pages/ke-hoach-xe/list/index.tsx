...
const KeHoachXe = props => {
  ...
  const nameObjectLocal = "KeHoachXeSearch";
  const KeHoachXeSearch = getItemLocalStorage(nameObjectLocal);
  ...
  useEffect(() => {
    const setDefaultValues = () => {
      expandRef.current?.setFieldValue("unit", KeHoachXeSearch?.unit);
    };
    setDefaultValues();
    onClickSearch();
  }, []);
