export const RouterLink = {
  ...
  PLAN_MONTH_DETAIL: "/training/plan/month/:id", // Kế hoạch huấn luyện tháng
  ...
  DOCS_TRAIN_DETAIL: "/training/docs/train/:id", // Giáo án huấn luyện
